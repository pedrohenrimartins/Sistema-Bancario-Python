...
class Conta(ABC):
    ...
    # Um atributo de classe que calcula quantas contas foram criadas
    total_contas = 0
    ...
    def extrato(self):
        ...
        # Caso haja transações registradas
...
class ContaCorrente(Conta):
        ...
        def __init__(self, numero, cliente, limite: float = 500):
        ...
        def sacar(self, valor: float):
            ...
            # Reduz o valor do saque no saldo
            self._saldo -= valor
